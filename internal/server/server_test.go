...
import (
	...
	"github.com/omarkhodr/proglog/internal/auth"
	"github.com/omarkhodr/proglog/internal/config"
...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	// Helper for setting up a new client
	newClient := func(crtPath, keyPath string) (
		*grpc.ClientConn,
		api.LogClient,
		[]grpc.DialOption,
	) {
		// Setup the client and its TLS credentials
	...
	// Setup the server, hook it up with its certificate and enable it to
